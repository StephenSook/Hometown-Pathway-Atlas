...
| 5.8 | Architecture diagram for repo | `docs/architecture.svg` | Vinh | ✅ | 5.1 | Done 2026-05-04. SVG diagram (4-layer: ingest → backend services/routes → frontend hooks/components → user journey). Replaces Mermaid placeholder in README. |
